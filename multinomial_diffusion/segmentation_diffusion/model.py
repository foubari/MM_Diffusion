...
from multinomial_diffusion.diffusion_utils.diffusion_multinomial import MultinomialDiffusion, CondMultinomialDiffusion, PartialDiffusion, MultimodalMultinomialDiffusion
...
def add_model_args(parser):
    ...
    parser.add_argument('--multimodal', type=eval, default=False)
    ...
    parser.add_argument('--modalities_vaes', type=list, default=[])
    parser.add_argument('--strategy', type=str, default='mixture_of_experts')
...
def get_model(args, data_shape):
    ...
    if args.partial:
        ...
        base_dist = MultimodalMultinomialDiffusion(
            args.num_classes, current_shape, dynamics, modalities_vaes=args.modalities_vaes, timesteps=args.diffusion_steps,
            loss_type=args.loss_type, loss_weighted=args.loss_weighted, parametrization=args.param, strategy=args.strategy)
    else:
